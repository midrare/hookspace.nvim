...
---@param pred function(any): boolean true if should include
---@param invert? boolean switch include and exclude
...
---@param items any[] items to filter
---@param pred function(o: any): boolean true if should include
---@param invert? boolean switch include and exclude
